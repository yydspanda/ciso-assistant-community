...
# The Phase 1 regulatory API is read-only. Ingest, applicability recording, and
# review transitions remain explicit domain-service permissions and are not
# generic model CRUD rights.
REGULATORY_READ_PERMISSIONS = ["view_regulatorydocument"]
REGULATORY_APPLICABILITY_READ_PERMISSIONS = [
    "view_regulatoryapplicabilitydecision",
]
REGULATORY_APPLICABILITY_REVIEW_READ_PERMISSIONS = [
    "view_regulatoryapplicabilityreviewdisposition",
]
REGULATORY_APPLICABILITY_REVIEW_PERMISSIONS = [
